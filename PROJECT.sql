...
SELECT * FROM books where genre = 'Fantasy' order by price desc limit 5;


-- 6) Retrieve the total quantity of books sold by each author:
/*SELECT book_id, COUNT(quantity) as total_quantity
FROM Orders
GROUP BY Book_id*/
SELECT b.author, o.book_id, sum(o.quantity) as total_quantity
FROM Orders o JOIN Books b on o.book_id = b.book_id
GROUP BY o.Book_id, b.author ORDER BY total_quantity;
-- 7) List the cities where customers who spent over $30 are located:
SELECT * FROM Customers

SELECT DISTINCT c.city,total_amount
FROM Orders o JOIN Customers c 
ON o.customer_id= c.customer_id WHERE total_amount >30
...
select DISTINCT b.book_id, b.title, b.stock,COALESCE (SUM(o.quantity), 0)  AS order_quantity,
